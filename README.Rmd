...
library(ggpubr)
data(mpdta)
devtools::load_all("C:/Users/E104368/OneDrive - County of San Diego/Documents/CallawaySAvignette")
library(BMisc)
```

# Difference-in-Differences <img src="man/figures/logo.png" align="right" width="155"/>
